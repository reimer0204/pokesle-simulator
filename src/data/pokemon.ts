...
class Pokemon {
  static list: PokemonType[] = [
    ...
    { name: 'バタフリー', specialty: 'きのみ', berry: 'ラム', foodList: ['あまいミツ', 'あんみんトマト', 'ワカクサ大豆'], skill: '食材ゲットS', help: 2600, bag: 21, foodRate: 0.197, skillRate: 0.014, legend: false, exp: 1, candyName: 'キャタピー', evolve: {before: 'トランセル', lv: 8, candy: 80, itemList: '', sleep: null }},
    ...
    { name: 'ドードリオ', specialty: 'きのみ', berry: 'シーヤ', foodList: ['ワカクサ大豆', 'リラックスカカオ', 'マメミート'], skill: 'げんきチャージS', help: 2400, bag: 21, foodRate: 0.184, skillRate: 0.02, legend: false, exp: 1, candyName: 'ドードー', evolve: {before: 'ドードー', lv: 23, candy: 40, itemList: '', sleep: null }},
    ...
    { name: 'チルタリス', specialty: 'きのみ', berry: 'ヤチェ', foodList: ['とくせんエッグ', 'ワカクサ大豆', 'とくせんリンゴ'], skill: 'げんきチャージS', help: 3700, bag: 14, foodRate: 0.258, skillRate: 0.061, legend: false, exp: 1, candyName: 'チルット', evolve: {before: 'チルット', lv: 26, candy: 40, itemList: '', sleep: null }},
