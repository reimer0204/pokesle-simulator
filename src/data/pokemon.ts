...
class Pokemon {
  static list: PokemonType[] = [
    ...
    { name: 'カモネギ', specialty: '食材', berry: 'シーヤ', foodList: ['ふといながねぎ', 'マメミート', 'あったかジンジャー'], skill: 'エナジーチャージS', help: 3000, bag: 18, foodRate: 0.16, skillRate: 0.043, legend: false, exp: 1, candyName: 'カモネギ', evolve: {before: null, lv: null, candy: null, itemList: '', sleep: null }},
    ...
    { name: 'ハガネール', specialty: 'きのみ', berry: 'ベリブ', foodList: ['あんみんトマト', 'マメミート', 'ほっこりポテト'], skill: '食材ゲットS', help: 3000, bag: 25, foodRate: 0.154, skillRate: 0.032, legend: false, exp: 1, candyName: 'イワーク', evolve: {before: 'イワーク', lv: null, candy: 80, itemList: 'メタルコート,つながりのヒモ', sleep: null }},
    ...
    { name: 'キモリ', specialty: 'スキル', berry: 'ドリ', foodList: ['とくせんエッグ', 'めざましコーヒー', 'ふといながねぎ'], skill: 'きのみバースト', help: 4500, bag: 8, foodRate: 0.172, skillRate: 0.035, legend: false, exp: 1, candyName: 'キモリ', evolve: {before: null, lv: null, candy: null, itemList: '', sleep: null }},
    { name: 'ジュプトル', specialty: 'スキル', berry: 'ドリ', foodList: ['とくせんエッグ', 'めざましコーヒー', 'ふといながねぎ'], skill: 'きのみバースト', help: 3300, bag: 11, foodRate: 0.15, skillRate: 0.035, legend: false, exp: 1, candyName: 'キモリ', evolve: {before: 'キモリ', lv: 12, candy: 40, itemList: '', sleep: null }},
    { name: 'ジュカイン', specialty: 'スキル', berry: 'ドリ', foodList: ['とくせんエッグ', 'めざましコーヒー', 'ふといながねぎ'], skill: 'きのみバースト', help: 2300, bag: 17, foodRate: 0.107, skillRate: 0.03, legend: false, exp: 1, candyName: 'キモリ', evolve: {before: 'ジュプトル', lv: 27, candy: 80, itemList: '', sleep: null }},
    { name: 'アチャモ', specialty: 'きのみ', berry: 'ヒメリ', foodList: ['あじわいキノコ', 'ワカクサ大豆', 'ピュアなオイル'], skill: 'げんきチャージS', help: 4300, bag: 12, foodRate: 0.16, skillRate: 0.044, legend: false, exp: 1, candyName: 'アチャモ', evolve: {before: null, lv: null, candy: null, itemList: '', sleep: null }},
    { name: 'ワカシャモ', specialty: 'きのみ', berry: 'クラボ', foodList: ['あじわいキノコ', 'ワカクサ大豆', 'ピュアなオイル'], skill: 'げんきチャージS', help: 3400, bag: 16, foodRate: 0.17, skillRate: 0.052, legend: false, exp: 1, candyName: 'アチャモ', evolve: {before: 'アチャモ', lv: null, candy: 40, itemList: '', sleep: null }},
    { name: 'バシャーモ', specialty: 'きのみ', berry: 'クラボ', foodList: ['あじわいキノコ', 'ワカクサ大豆', 'ピュアなオイル'], skill: 'げんきチャージS', help: 2600, bag: 22, foodRate: 0.153, skillRate: 0.049, legend: false, exp: 1, candyName: 'アチャモ', evolve: {before: 'ワカシャモ', lv: null, candy: 80, itemList: '', sleep: null }},
    { name: 'ミズゴロウ', specialty: 'きのみ', berry: 'オレン', foodList: ['ワカクサコーン', 'モーモーミルク', 'あじわいキノコ'], skill: '料理チャンスS', help: 4700, bag: 11, foodRate: 0.192, skillRate: 0.024, legend: false, exp: 1, candyName: 'ミズゴロウ', evolve: {before: null, lv: null, candy: null, itemList: '', sleep: null }},
    { name: 'ヌマクロー', specialty: 'きのみ', berry: 'フィラ', foodList: ['ワカクサコーン', 'モーモーミルク', 'あじわいキノコ'], skill: '料理チャンスS', help: 3500, bag: 16, foodRate: 0.168, skillRate: 0.028, legend: false, exp: 1, candyName: 'ミズゴロウ', evolve: {before: 'ミズゴロウ', lv: null, candy: 40, itemList: '', sleep: null }},
    { name: 'ラグラージ', specialty: 'きのみ', berry: 'フィラ', foodList: ['ワカクサコーン', 'モーモーミルク', 'あじわいキノコ'], skill: '料理チャンスS', help: 2800, bag: 20, foodRate: 0.146, skillRate: 0.034, legend: false, exp: 1, candyName: 'ミズゴロウ', evolve: {before: 'ヌマクロー', lv: null, candy: 80, itemList: '', sleep: null }},
    ...
    { name: 'クチート', specialty: '食材', berry: 'ベリブ', foodList: ['ピュアなオイル', 'ワカクサコーン', 'あんみんトマト'], skill: 'かいりきバサミ(食材セレクトS)', help: 3200, bag: 17, foodRate: 0.204, skillRate: 0.038, legend: false, exp: 1, candyName: 'クチート', evolve: {before: null, lv: null, candy: null, itemList: '', sleep: null }},
    ...
    { name: 'プラスル', specialty: 'スキル', berry: 'ウブ', foodList: ['めざましコーヒー', 'ふといながねぎ', 'モーモーミルク'], skill: 'プラス(食材ゲットS)', help: 2400, bag: 16, foodRate: 0.103, skillRate: 0.049, legend: false, exp: 1, candyName: 'プラスル', evolve: {before: null, lv: null, candy: null, itemList: '', sleep: null }},
    { name: 'マイナン', specialty: 'スキル', berry: 'ウブ', foodList: ['あまいミツ', 'とくせんエッグ', 'モーモーミルク'], skill: 'マイナス(料理パワーアップS)', help: 2400, bag: 16, foodRate: 0.174, skillRate: 0.049, legend: false, exp: 1, candyName: 'マイナン', evolve: {before: null, lv: null, candy: null, itemList: '', sleep: null }},
